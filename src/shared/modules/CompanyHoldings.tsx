      ...
      <>
        <HStack>
          ...
          <Text
            ...
            textAlign={"left"}
          >
            Explore Companies Holding BITCOIN
          </Text>
          <VStack>
            <BTCLogo height={"35px"} width={"35px"} />
          </VStack>{" "}
        </HStack>
        <Text
          fontSize="xl"
          ...
          textAlign={"left"}
        >
          Track publicly traded companies around the world that are buying
          Bitcoin as part of corporate treasury
        </Text>
      ...
      <>
        <HStack>
          ...
          <Text
            ...
            textAlign={"left"}
          >
            Explore Companies Holding Ethereum
          </Text>
          <VStack>
            <ETHLogo height={"35px"} width={"35px"} />
          </VStack>{" "}
        </HStack>
        <Text
          fontSize="xl"
